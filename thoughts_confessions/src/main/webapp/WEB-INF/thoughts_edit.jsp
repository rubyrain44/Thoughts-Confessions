...
<head>
    <meta charset="UTF-8">
    <title>Update Your Thought</title>
...
<body class="thoughts">
   	<div class="navBar">
		...
		<div class="updateThought">
			<h3>Update Your Thought</h3>
			
   		<form:form action="/thoughts/edit/${thought.id}" method="POST" modelAttribute="thought">
